...
// test methods
static void testInsertAndFind_Float (void);
static void testDelete_Float (void);
static void testDelete_String (void);
...
testDelete_Float (void)
{
  ...
  testName = "test b-tree delete Float";
  int i, iter;
  BTreeHandle *tree = NULL;
  int numDeletes = 3;
...
testDelete_String (void)
{
  ...
  testName = "test b-tree Delete String";
  int i, iter;
  BTreeHandle *tree = NULL;
  int numDeletes = 3;
  bool *deletes = (bool *) malloc(numInserts * sizeof(bool));
